		...
		<Backdrop onClick={handleClose}>
			{type === "dropIn" && (
				<motion.div
					...
					className="rounded-xl flex flex-col justify-center bg-white dark:bg-[#1D2226] w-full max-w-lg md:-mt-70 mx-6"
					variants={dropIn}
					initial="hidden"
					animate="visible"
					exit="exit"
				>
					<div className="flex items-center justify-between border-b border-gray-300 dark:border-white/75 px-4 py-2.5">
			...
			{type === "gifYouUp" && (
				<motion.div
					onClick={(e) => e.stopPropagation()}
					className="rounded-lg flex flex-col md:flex-row bg-gray-900 w-full max-w-6xl -mt-[7vh] mx-6"
					variants={gifYouUp}
					initial="hidden"
					animate="visible"
					exit="exit"
